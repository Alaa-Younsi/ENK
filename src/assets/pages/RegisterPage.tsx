...
import RegisterForm from '../components/Layout/Home/Auth/RegisterForm.tsx';

const RegisterPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden py-20 sm:py-12 px-4">
      {/* Background */}
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 px-6 sm:px-8 py-6">
            <div className="flex items-center justify-center gap-3 sm:gap-4 mb-4">
              ...
              <div className="text-white">
                ...
                <p className="text-xs sm:text-sm text-purple-100">Formulaire d'Inscription</p>
              </div>
            </div>
          </div>
